...
(function () {
  ...
  window.gardis_storage_get = function (var_name) {
    return gardis_isset(GARDIS_STORAGE[var_name])
      ? GARDIS_STORAGE[var_name]
      : "";
  };
  ...
  window.gardis_storage_get_array = function (var_name, key) {
    return gardis_isset(GARDIS_STORAGE[var_name][key])
      ? GARDIS_STORAGE[var_name][key]
      : "";
  };
  ...
  window.gardis_empty = function (obj) {
    return (
      ...
      (typeof obj == "string" && gardis_alltrim(obj) == "") ||
      obj === 0
    );
  };
      ...
      case "object":
        if (mixed_val == null) return "N;";
          ...
          for (var i = 0; i < mixed_val.length; i++) {
            ...
            if (ser) map.push(gardis_serialize(idxobj.idx) + ser);
          }
          ...
          for (var prop in mixed_val) {
            ...
            if (ser) props.push(gardis_serialize(prop) + ser);
          }
          if (obj_to_array)
  ...
  window.gardis_get_date_difference = function (dt1) {
    ...
    } else var a2 = gardis_parse_date(dt2);
  ...
  window.gardis_color_picker_show = function (id, fld, func) {
    ...
    var def =
      fld.val().substr(0, 1) == "#"
        ? fld.val()
        : gardis_rgb2hex(fld.css("backgroundColor"));
    jQuery(
      ...
      for (var prop in obj) {
        ...
        if (
          ...
          dispStr +=
            ...
            prop +
            "=" +
            gardis_debug_object(obj[prop], recursive, showMethods, level + 1);
        else {
          try {
            curStr = "" + obj[prop];
          } catch (e) {
  ...
  window.gardis_debug_log = function (s, clr) {
    if (GARDIS_STORAGE["user_logged_in"]) {
      if (jQuery("#debug_log").length == 0) {
        jQuery("body").append(
          '<div id="debug_log"><span id="debug_log_close">x</span><pre id="debug_log_content"></pre></div>'
        );
  ...
  window.dco === undefined &&
    (window.dco = function (s, r) {
      console.log(gardis_debug_object(s, r));
    });
  window.dal === undefined &&
    (window.dal = function (s) {
      if (GARDIS_STORAGE["user_logged_in"]) alert(s);
    });
  window.dao === undefined &&
    (window.dao = function (s, r) {
      if (GARDIS_STORAGE["user_logged_in"]) alert(gardis_debug_object(s, r));
    });
  window.ddl === undefined &&
    (window.ddl = function (s, c) {
      gardis_debug_log(s, c);
    });
  window.ddo === undefined &&
    (window.ddo = function (s, r, c) {
      gardis_debug_log(gardis_debug_object(s, r), c);
    });
})();
jQuery(document).ready(function () {
  ...
  function gardis_init_actions() {
    ...
    if (
      jQuery(
        'input[type="checkbox"][name="i_agree_privacy_policy"]:not(.inited),input[type="checkbox"][name="gdpr_terms"]:not(.inited),input[type="checkbox"][name="wpgdprc"]:not(.inited),input[type="checkbox"][name="AGREE_TO_TERMS"]:not(.inited)'
      ).length > 0
    ) {
      jQuery(
        'input[type="checkbox"][name="i_agree_privacy_policy"]:not(.inited),input[type="checkbox"][name="gdpr_terms"]:not(.inited),input[type="checkbox"][name="wpgdprc"]:not(.inited),input[type="checkbox"][name="AGREE_TO_TERMS"]:not(.inited)'
    ...
    jQuery(document).on(
      "action.sc_layouts_row_fixed_off",
      gardis_stretch_height
    );
    jQuery(document).on(
    ...
    if (
      ...
      !gardis_check_images_complete(jQuery(".menu_side_wrap .sc_layouts_logo"))
    ) {
      setTimeout(function () {
  ...
  function gardis_ready_actions() {
          ...
          src: [
            {
              ...
              type:
                "video/" +
                gardis_get_file_ext(GARDIS_STORAGE["background_video"]),
            },
          ],
          onLoad: function () {},
        });
    ...
    if (
      jQuery(".gardis_tabs:not(.inited)").length > 0 &&
      jQuery.ui &&
      jQuery.ui.tabs
    ) {
    ...
    jQuery(".gardis_tabs_ajax").on("tabsbeforeactivate", function (event, ui) {
      if (ui.newPanel.data("need-content"))
        gardis_tabs_ajax_content_loader(ui.newPanel, 1, ui.oldPanel);
    });
    ...
    jQuery(".menu_mobile").on(
      ...
      function (e) {
        ...
        if (
          !jQuery(this).hasClass("open_child_menu") &&
          gardis_is_local_link($a.attr("href"))
        )
    ...
    if (
      !GARDIS_STORAGE["trx_addons_exist"] ||
    ...
    jQuery(".trx-stretch-width").wrap(
      '<div class="trx-stretch-width-wrap"></div>'
    );
    ...
    jQuery(".nav-links-more a").on("click", function (e) {
      ...
      function gardis_loadmore_add_items(container, items) {
        ...
        else GARDIS_STORAGE["load_more_link_busy"] = false;
        jQuery(window).trigger("scroll");
      }
      e.preventDefault();
      return false;
  ...
  function gardis_stretch_height(e, cont) {
    ...
    cont.find(".gardis-full-height").each(function () {
      ...
      if (fullheight_row.length > 0)
        ...
        var wh =
          jQuery(window).width() >= 960 ? jQuery(window).height() - fh : "auto";
        if (wh > 0) {
          ...
          if (fullheight_item.data("display") == undefined)
            fullheight_item.attr(
              "data-display",
              fullheight_item.css("display")
            );
    ...
    if (sb.length > 0) {
      if (content.css("float") == "none") {
        ...
        if (
          ...
          if (scroll_dir == 0) scroll_dir = GARDIS_STORAGE["scroll_dir_last"];
          ...
          if (sb_init.position != "undefined") {
            ...
            if (
              sb_init.position == "fixed" ||
              (!jQuery("body").hasClass("body_style_wide") &&
                !jQuery("body").hasClass("body_style_boxed"))
            ) {
  ...
  function gardis_init_media_elements(cont) {
    if (
      GARDIS_STORAGE["use_mediaelements"] &&
      cont.find("audio:not(.inited),video:not(.inited)").length > 0
    ) {
      if (window.mejs) {
        ...
        cont.find("audio:not(.inited),video:not(.inited)").each(function () {
          ...
          if (
            ...
            jQuery(this).parents(".elementor-background-video-container")
              .length === 0 &&
  ...
  function gardis_tabs_ajax_content_loader(panel, page, oldPanel) {
    if (panel.html().replace(/\s/g, "") == "") {
      ...
      panel.html(
        '<div class="gardis_tab_holder" style="min-height:' +
          height +
          'px;"></div>'
      );
    } else panel.find("> *").addClass("gardis_tab_content_remove");
      ...
      .done(function (response) {
        ...
        if (rez.error !== "") {
          ...
          panel.prepend(rez.data).fadeIn(function () {
            ...
            setTimeout(function () {
              panel
                .find(".gardis_tab_holder,.gardis_tab_content_remove")
                .remove();
              jQuery(window).trigger("scroll");
            }, 600);
          });
  ...
  function gardis_comments_validate(form) {
    ...
    var comments_args = {
      error_message_text: GARDIS_STORAGE["strings"]["error_global"],
      error_message_show: true,
      error_message_time: 4000,
      error_message_class: "gardis_messagebox gardis_messagebox_style_error",
      ...
      rules: [
        {
          ...
          min_length: {
            value: 1,
            message: GARDIS_STORAGE["strings"]["text_empty"],
          },
          max_length: {
            value: GARDIS_STORAGE["comment_maxlength"],
            message: GARDIS_STORAGE["strings"]["text_long"],
          },
        },
      ],
    };
    if (form.find('.comments_author input[aria-required="true"]').length > 0) {
      comments_args.rules.push({
        ...
        min_length: {
          value: 1,
          message: GARDIS_STORAGE["strings"]["name_empty"],
        },
        max_length: {
          value: 60,
          message: GARDIS_STORAGE["strings"]["name_long"],
        },
      });
    }
    if (form.find('.comments_email input[aria-required="true"]').length > 0) {
      comments_args.rules.push({
        ...
        min_length: {
          value: 1,
          message: GARDIS_STORAGE["strings"]["email_empty"],
        },
        max_length: {
          value: 60,
          message: GARDIS_STORAGE["strings"]["email_long"],
        },
        mask: {
          value: GARDIS_STORAGE["email_mask"],
          message: GARDIS_STORAGE["strings"]["email_not_valid"],
        },
      });
    }
...
jQuery(document).on("action.init_hidden_elements", function (e, cont) {
  "use strict";
  if (
    GARDIS_STORAGE["button_hover"] &&
    GARDIS_STORAGE["button_hover"] != "default"
  ) {
    jQuery(
      'button:not(.search_submit):not([class*="sc_button_hover_"]), .theme_button:not([class*="sc_button_hover_"]), .sc_button:not([class*="sc_button_simple"]):not([class*="sc_button_hover_"]), .sc_form_field button:not([class*="sc_button_hover_"]), .post_item .more-link:not([class*="sc_button_hover_"]), .trx_addons_hover_content .trx_addons_hover_links a:not([class*="sc_button_hover_"]), .gardis_tabs .gardis_tabs_titles li a:not([class*="sc_button_hover_"]), .hover_shop_buttons .icons a:not([class*="sc_button_hover_style_"]), .mptt-navigation-tabs li a:not([class*="sc_button_hover_style_"]), .edd_download_purchase_form .button:not([class*="sc_button_hover_style_"]), .edd-submit.button:not([class*="sc_button_hover_style_"]), .widget_edd_cart_widget .edd_checkout a:not([class*="sc_button_hover_style_"]), .woocommerce #respond input#submit:not([class*="sc_button_hover_"]), .woocommerce .button:not([class*="shop_"]):not([class*="view"]):not([class*="sc_button_hover_"]), .woocommerce-page .button:not([class*="shop_"]):not([class*="view"]):not([class*="sc_button_hover_"]), #buddypress a.button:not([class*="sc_button_hover_"]) '
    ).addClass(
      "sc_button_hover_just_init sc_button_hover_" +
        GARDIS_STORAGE["button_hover"]
    );
    if (GARDIS_STORAGE["button_hover"] != "arrow") {
      jQuery(
        'input[type="submit"]:not([class*="sc_button_hover_"]), input[type="button"]:not([class*="sc_button_hover_"]), .vc_tta-accordion .vc_tta-panel-heading .vc_tta-controls-icon:not([class*="sc_button_hover_"]), .vc_tta-color-grey.vc_tta-style-classic .vc_tta-tab > a:not([class*="sc_button_hover_"]), .single-product div.product .woocommerce-tabs .wc-tabs li a, .woocommerce nav.woocommerce-pagination ul li a:not([class*="sc_button_hover_"]), .tribe-events-button:not([class*="sc_button_hover_"]), #tribe-bar-views .tribe-bar-views-list .tribe-bar-views-option a:not([class*="sc_button_hover_"]), .tribe-bar-mini #tribe-bar-views .tribe-bar-views-list .tribe-bar-views-option a:not([class*="sc_button_hover_"]), .tribe-events-cal-links a:not([class*="sc_button_hover_"]), .tribe-events-sub-nav li a:not([class*="sc_button_hover_"]), .isotope_filters_button:not([class*="sc_button_hover_"]), .trx_addons_scroll_to_top:not([class*="sc_button_hover_"]), .sc_promo_modern .sc_promo_link2:not([class*="sc_button_hover_"]), .post_item_single .post_content .post_meta .post_share .social_item .social_icon:not([class*="sc_button_hover_"]), .slider_container .slider_prev:not([class*="sc_button_hover_"]), .slider_container .slider_next:not([class*="sc_button_hover_"]), .sc_slider_controller_titles .slider_controls_wrap > a:not([class*="sc_button_hover_"]), .tagcloud > a:not([class*="sc_button_hover_"]) '
      ).addClass(
        "sc_button_hover_just_init sc_button_hover_" +
          GARDIS_STORAGE["button_hover"]
      );
    ...
    jQuery(
      '.trx_addons_hover_content .trx_addons_hover_links a:not([class*="sc_button_hover_style_"]), .single-product ul.products li.product .post_data .button:not([class*="sc_button_hover_style_"]) '
    ...
    jQuery(
      '.woocommerce .woocommerce-message .button:not([class*="sc_button_hover_style_"]), .woocommerce .woocommerce-info .button:not([class*="sc_button_hover_style_"]) '
    ).addClass("sc_button_hover_just_init sc_button_hover_style_alter");
    jQuery(
      '.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]), .gardis_tabs .gardis_tabs_titles li a:not([class*="sc_button_hover_style_"]), .widget_tag_cloud a:not([class*="sc_button_hover_style_"]), .widget_product_tag_cloud a:not([class*="sc_button_hover_style_"]) '
    ...
    jQuery(
      ".mejs-controls button, .mfp-close, .sc_button_bg_image, .hover_shop_buttons a, button.pswp__button, .woocommerce-orders-table__cell-order-actions .button, .sc_layouts_row_type_narrow .sc_button "
    ).removeClass("sc_button_hover_" + GARDIS_STORAGE["button_hover"]);
  }
});
(function () {
  "use strict";
  jQuery(document).on(
    ...
    gardis_trx_addons_add_googlemap_styles
  );
  jQuery(document).on("action.init_shortcodes", gardis_trx_addons_init);
  jQuery(document).on("action.init_hidden_elements", gardis_trx_addons_init);
  function gardis_trx_addons_add_googlemap_styles(e) {
  ...
  function gardis_trx_addons_init(e, container) {
    ...
    container
      ...
      .addClass("inited")
      .attr("data-color", GARDIS_STORAGE["alter_link_color"]);
  }
})();
(function () {
  "use strict";
  jQuery(document).on("action.ready_gardis", function () {
    jQuery(".woocommerce,.woocommerce-page").on(
      "click",
      ".gardis_shop_mode_buttons a",
      function (e) {
        var mode = jQuery(this).hasClass("woocommerce_thumbs")
          ? "thumbs"
          : "list";
        gardis_set_cookie("gardis_shop_mode", mode, 365);
        jQuery(this)
          .siblings("input")
          .val(mode)
          .parents("form")
    ...
    function woocomerce_inc_dec_click(button) {
      ...
      if (button.hasClass("q_inc")) {
        ...
        f.val(Math.max(1, Math.max(0, parseInt(f.val())) - 1)).trigger(
          "change"
        );
      }
    }
    ...
    jQuery(document.body).on(
      "wc_fragments_refreshed updated_shipping_method update_checkout",
      function () {
  ...
  jQuery(document).on("action.prepare_stretch_width", function () {
    if (GARDIS_STORAGE["stretch_tabs_area"] > 0)
